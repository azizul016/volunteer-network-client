        ...
        <>
            ...
            <div className="form-container">
                ...
                <form className="form" onSubmit={handleSubmit}>
                    <input type="text" required placeholder="Full Name" value={loggedInUser.name} id="name" />
                    <br />
                    <input type="email" required placeholder="Username or Email" value={loggedInUser.email} name="" id="email" />
                    <br />
                    <input type="date" id="date" />
                    <br />
                    <input type="text" placeholder="Description" id="description" required />
                    <br />
                    <input type="text" required value={volunteers && volunteers.title} placeholder="Activities" id="title" />
                    <br />
                    <button className="registerBtn" type="submit">Registration</button>
                </form>
            </div>
        </>
    );
